export default class DataHora {
    constructor(
        private elementoData: HTMLInputElement | null = document.querySelector("#datetime > div:nth-child(2)"),
        private elementoHora: HTMLInputElement | null = document.querySelector("#datetime time ")
        ) {
            this.renderizar();
